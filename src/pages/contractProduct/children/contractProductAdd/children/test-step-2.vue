...
<script type="es6">
    ...
    import VProductSelectStep2 from '../components/new-product-select-modal'
            ...
            'prmLists': {
                handler: function (a,b) {
                    /*console.log(a);
                     ...
                     if(a[index].pdRights.contentLimit!=b[index].pdRights.contentLimit){
                     console.log(222)
                     //如果为内容限定，清除所有信息
                     item.pmLists.forEach(function (subItem) {
                     subItem.tableName='';
                     subItem.matchValues='';
                     })
                     }
